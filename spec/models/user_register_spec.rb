...
# Unit tests for MailSafePro::UserRegister
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MailSafePro::UserRegister do
  #let(:instance) { MailSafePro::UserRegister.new }

  describe 'test an instance of UserRegister' do
    it 'should create an instance of UserRegister' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MailSafePro::UserRegister)
    end
  end
