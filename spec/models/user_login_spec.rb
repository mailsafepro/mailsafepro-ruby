...
# Unit tests for MailSafePro::UserLogin
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MailSafePro::UserLogin do
  #let(:instance) { MailSafePro::UserLogin.new }

  describe 'test an instance of UserLogin' do
    it 'should create an instance of UserLogin' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MailSafePro::UserLogin)
    end
  end
