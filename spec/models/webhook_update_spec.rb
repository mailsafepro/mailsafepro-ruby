...
# Unit tests for MailSafePro::WebhookUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MailSafePro::WebhookUpdate do
  #let(:instance) { MailSafePro::WebhookUpdate.new }

  describe 'test an instance of WebhookUpdate' do
    it 'should create an instance of WebhookUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MailSafePro::WebhookUpdate)
    end
  end
